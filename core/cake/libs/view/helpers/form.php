 ...
 */
    ...
    function autocomplete($fieldName, $options = array())
    {
		...
		if (isset($options['acMultiple']) && $options['acMultiple']) {
			...
			$params['accontrollers'] = $options['accontrollers'];
        } else {
		...
		if(is_array($acFieldKey) && ($classSelector == 'js-multi-autocomplete') ){
			$acFieldKey = array_shift($acFieldKey);
		}
