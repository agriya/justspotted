...
class ListHelper extends AppHelper {
    ...
    /**
     * Create an unordered nested list from tree data. You can define a public function called 
     ...
     * @return string
     */
    public function createNestedTree($data, $settings = array()) {
    ...
    /**
     * Create an unordered list from tree data. You can define a public function called 
     ...
     * @return string
     */
    public function createTree($data, $settings = array()) {
    ...
    static public function resetOddCounter() {
        self::$isOdd = true;
    }
