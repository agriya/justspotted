...
<?php else: ?>
    ...
    <div class="captcha-block clearfix js-captcha-container">
        ...
        <div class="captcha-right grid_left">
			...
			<div>
				<?php echo $this->Html->link(__l('Click to play'), Router::url('/', true) . 'flash/securimage/play.swf?audio=' . $this->Html->url(array('controller' => 'contacts', 'action' => 'captcha_play'), true) . '&bgColor1=#777&bgColor2=#fff&iconColor=#000&roundedCorner=5&height=19&width=19&wmode=transparent', array('class' => 'js-captcha-play')); ?>
			</div>
        </div>
    </div>
    <?php
