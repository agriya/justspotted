...
<div class="admin-side1-tl ">
	<div class="admin-side1-tr">
	  <div class="admin-side1-tc page-title-info">
		<h2 class="chart-dashboard-title"><?php echo __l('Registration').' - '.$page_title; ?>
		<span class="js-chart-showhide <?php echo $arrow; ?> {'chart_block':'admin-dashboard-user<?php echo $user_type_id; ?>', 'dataloading':'div.js-loadadmin-chart-users-ctp',  'dataurl':'admin/charts/chart_users/is_ajax_load:1/user_type_id:<?php echo $user_type_id; ?>'}"><?php echo $arrow; ?></span></h2>
	  </div>
	</div>
</div>
...
<div class="admin-center-block clearfix dashboard-center-block" id="admin-dashboard-user<?php echo $user_type_id; ?>">
    <div class="clearfix">
     <?php echo $this->Form->create('Chart' , array('class' => "language-form {'chart_block':'admin-dashboard-user". $user_type_id . "', 'dataloading':'div.js-loadadmin-chart-users-ctp'}", 'action' => 'chart_users')); ?>
		<?php
