...
?>
			<li>
                	...
                	<?php echo $this->Html->link(__l('Edit'), array('controller' => 'business_updates', 'action' => 'edit', $businessUpdate['BusinessUpdate']['id']), array('class' => 'edit js-edit', 'title' => __l('Edit'))); ?>
