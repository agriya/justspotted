<?php /* SVN: $Id: admin_edit.ctp 71591 2011-11-15 19:01:34Z josephine_065at09 $ */ ?>
            ...
            <?php
            	...
            	<?php
					...
					if(!empty($this->request->data['PageLogo'])){
						...
						<div class="bg-img-subscription"><?php	echo $this->Html->showImage('PageLogo', $value, array('dimension' => 'medium_thumb', 'alt' => Inflector::humanize($value['description']) , 'title' => Inflector::humanize($value['description']))); ?> </div>
					</div>	<?php	}
						}
					}
				?>
