...
* @access public
*/
public public function __construct($id = false, $table = null, $ds = null) {
...
* @access public
*/
public public function __constructLinkedModel($assoc, $className = null) {
...
*/
public public function __isset($alias) {
...
*/
public public function &__get($alias) {
...
* @access private
*/
private public function constructLazyLinkedModel($assoc, $className = null) {
if (empty($className)) {
$className = $assoc;
}
...
* @access private
*/
private public function map($key, $properties) {
...
* @access private
*/
private public function properties($key, $properties) {
if (is_numeric($key)) {
...
* @access public
*/
public public function bindModel($models, $reset = true) {
...
* @access public
*/
public public function resetAssociations() {
...
* @access private
*/
private public function pluginSplit($name, $dotAppend = false, $plugin = null) {
